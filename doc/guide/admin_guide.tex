...
\node (prawn) at (-3,-3) [draw] {\scriptsize Prawn};
\node (cwave) at (-1.5,-3) [draw] {\scriptsize Carrierwave};
\node (devise) at (0,-3) [draw] {\scriptsize Devise};
\node (cancan) at (1.5,-3) [draw] {\scriptsize Cancan};
\node (willp) at (3.5,-3) [draw] {\scriptsize Will\_Paginate};
\node (redcloth) at (5.5,-3) [draw] {\scriptsize Redcloth};
