...
to be restarted before the changes will take effect.
\end{center}
\end{plainblock}
...
\section{The Database Schema}\label{sec:database}
\subsection{Introduction}
...
\bibitem{sqlitemanager} \url{http://code.google.com/p/sqlite-manager/}
\bibitem{w3schoolssql} \url{http://www.w3schools.com/sql/}
\end{thebibliography}
\end{document}
